...
//    ff
    ...
    private func addStackView(){
        firstVerticalStackView = UIStackView(arrangedSubviews: [movieNameLabel,nameOfSelectedMovieLabel,changeNameButton])
        
        secondVerticalStackView = UIStackView(arrangedSubviews: [yourRatingLabel,selectedRatingLabel,changeRatingButton])
        
        thirdVerticalStackView = UIStackView(arrangedSubviews: [releaseDateLabel,selectedReleasingDateLabel,changeReleasingDateButton])
        
        fourthVerticalStackView = UIStackView(arrangedSubviews: [youtubeLinkLabel,selectedYoutubeLink,changeYoutubeLinkButton])
        
        horizontalOneStackView = UIStackView(arrangedSubviews: [firstVerticalStackView,secondVerticalStackView])
        
        horizontalTwoStackView = UIStackView(arrangedSubviews: [thirdVerticalStackView,fourthVerticalStackView])
        
        basicVerticalStackView = UIStackView(arrangedSubviews: [horizontalOneStackView,horizontalTwoStackView])
...
//    keyboard
    ...
    private func setupViewConstrains(){
        ...
        descriptionLabel.topAnchor.constraint(equalTo: basicVerticalStackView.bottomAnchor, constant:36).isActive = true
    ...
    private func setupUI(){
        ...
        nameOfSelectedMovieLabel.textColor = .black
        ...
        selectedReleasingDateLabel.textColor = .black
        ...
        selectedYoutubeLink.textColor = .black
...
//    keyboard
    ...
    @objc func changeName(sender: UIButton!) {
        ...
        let nameVC = storyboard.instantiateViewController(withIdentifier: "MovieNameViewController") as! MovieNameViewController
    ...
    @objc func changeDate(sender: UIButton!) {
        let storyboard = UIStoryboard(name: "Main", bundle: nil)
        let dateVC = storyboard.instantiateViewController(withIdentifier: "ReleasingDateViewController") as! ReleasingDateViewController
    ...
    @objc func changeRating(sender: UIButton!) {
        let storyboard = UIStoryboard(name: "Main", bundle: nil)
        let ratingVC = storyboard.instantiateViewController(withIdentifier: "YourRatingViewController") as! YourRatingViewController
    ...
    @objc func changeLink(sender: UIButton!) {
        let storyboard = UIStoryboard(name: "Main", bundle: nil)
        let linkVC = storyboard.instantiateViewController(withIdentifier: "YouTubeLinkViewController") as! YouTubeLinkViewController
    ...
    @objc func saveMovieAction(sender: UIButton!) {
        let movieInfo = Movies(movieName: nameOfSelectedMovieLabel.text!, movieRating: selectedRatingLabel.text!, releaseDate: selectedReleasingDateLabel.text!, youtubeLink: selectedYoutubeLink.text!, imageMovie: avatarImageView, description: descriptionTextView.text!)
        delegateMovie?.transferMovie(movieInfo)
        navigationController?.popViewController(animated: true)
        
//        
//        UserDefaults.standard.set(nameOfSelectedMovieLabel.text, forKey: Constants.Defaults.nameOfSelectedMovieLabel)
//        UserDefaults.standard.set(selectedRatingLabel.text, forKey: Constants.Defaults.selectedRatingLabel)
//        UserDefaults.standard.set(selectedReleasingDateLabel.text, forKey: Constants.Defaults.releasingLabel)
//        UserDefaults.standard.set(selectedYoutubeLink.text, forKey: Constants.Defaults.selectedYoutubeLink)
//        UserDefaults.standard.set(descriptionTextView.text, forKey: Constants.Defaults.descriptionTextView)
//        UserDefaults.standard.set(avatarImageView.image!, forKey: Constants.Defaults.avatarImageViewKey)
...
extension AddNewViewController: TransferNameBetweenVCDelegats {
    func transferName(_ text: String) {
        nameOfSelectedMovieLabel.text = text
    }
}

extension AddNewViewController: TransferDateBetweenVCDelegats {
...
extension AddNewViewController: TransferRatingBetweenVCDelegats {
    func transferText(_ text: String) {
        selectedRatingLabel.text = String(text)
        
    }
}

extension AddNewViewController: TransferLinkBetweenVCDelegats {
...
enum Constants {
            enum Defaults {
                static let avatarImageViewKey = "image"
                static let nameOfSelectedMovieLabel = "movieName"
                static let selectedRatingLabel = "rating"
                static let releasingLabel = "releasing"
                static let descriptionTextView = "description"
                static let selectedYoutubeLink = "youtubeLink"
            }
        }
